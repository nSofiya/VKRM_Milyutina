...
class BLJ_Tab(QWidget):
    ...
    def show_parameters(self):
        QMessageBox.information(
            self,
            "Параметры метода BLG",
            "Число генерируемых точек R = 50\n\n"
            "Максимальное число проходов P = 10\n\n"
            "Число итераций, выполняемых за один проход ITER = 50\n\n"
            "Коэффициент восстановления начального множества поиска nu = 0.9\n\n"
            "Коэффициент уменьшения размера множества поиска gamma = 0.9\n\n"
        )
